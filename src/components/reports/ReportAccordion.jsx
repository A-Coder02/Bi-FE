...
const ReportAccordion = ({children}) => {
  return (
    <CustomAccordion header = { <CustomButton>Upload Report</CustomButton>} title = 'Daily Report'>
    <Stack direction='row' spacing = {2} alignItems = 'center'>
      <Stack direction='row' spacing = {2} alignItems = 'center'>
      <CustomButton>Today's Report</CustomButton>
      <Typography>OR</Typography>
      <CustomDialog buttonTitle='See Report by Date' buttonProps={{endIcon : <ArrowDropDownIcon/>}} >
      <CustomDatePicker/>
      </CustomDialog>
      </Stack>
    </Stack>
